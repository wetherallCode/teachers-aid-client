...
export const ObjectIdentification = ({
	...
	const [transitiveQuestionMessage, setTransitiveQuestionMessage] = useState<string | null>(null)
		...
		<div>
			{step === 'stepOne' && (
				<div>
					<div>
						...
						{question.simplePredicate} has an object read your sentence
					</div>
					<br />
					<div>{questionToModify.join(' ')}</div>
					<div>
						and ask yourself: Did {question.completeSubject} {question.simplePredicate} something?
						If there is a clear answer to this quesiton, the answer is yes. If there isn't a clear
			...
			{step === 'stepTwo' && (
				<div>
					...
					<div>
						Things to remember: the object comes directly after the verb and is a noun or an
						adjective that describes the noun and the noun together.
					</div>
					<br />
