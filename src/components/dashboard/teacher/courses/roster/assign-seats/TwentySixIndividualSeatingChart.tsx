...
export type TwentySixIndividualSeatingChartProps = {
	course: string
	assignedSeats: findCourseByIdForStudentRegistration_findCourseById_course_hasCourseInfo_assignedSeats[]
	assignSeats: (
		options?: MutationFunctionOptions<assignRegularSeats, assignRegularSeatsVariables> | undefined
	) => void
	studentsInCourse: findCourseByIdForStudentRegistration_findCourseById_course_hasStudents[]
}

export const TwentySixIndividualSeatingChart = ({
	course,
	assignedSeats,
	assignSeats,
	studentsInCourse,
}: TwentySixIndividualSeatingChartProps) => {
	// <AssignedDesk
	...
	return (
		<>
			<TwentySixIndividualSeatFloorPlan>
				...
				{/*	<TripleSeatingGroup>
					<CenterSide>
						<TripleSeatDeskContainer></TripleSeatDeskContainer>
					</CenterSide>
					<CenterSide>
						<TripleSeatDeskContainer>
							<AssignedDesk
