...
export const RandomStudentGenerator = ({ presentStudentList }: RandomStudentGeneratorProps) => {
	...
	const randomCurrentStudent =
		presentStudentList[Math.floor(Math.random() * presentStudentList.length + 1)]
