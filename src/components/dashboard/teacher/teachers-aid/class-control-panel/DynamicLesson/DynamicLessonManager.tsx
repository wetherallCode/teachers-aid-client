...
export const DynamicLessonManager = ({ lesson, presentStudentList }: DynamicLessonManagerProps) => {
	const [updateDynamicLeson] = useMutation<updateDynamicLesson, updateDynamicLessonVariables>(
	...
	return (
		<DynamicLessonContainer>
			...
			<div style={{ gridColumn: '1/-1', display: 'grid', justifyItems: 'center' }}>
				<StudentInfoSelector />
			</div>
