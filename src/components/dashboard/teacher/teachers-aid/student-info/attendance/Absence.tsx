...
import { CREATE_STUDENT_ABSENCE_MUTATION, RemoveAbsenceType } from './DailyAttendance'
...
export const Absence = ({
	...
	const [createAbsence, { data, called }] = useMutation<createAbsence, createAbsenceVariables>(
