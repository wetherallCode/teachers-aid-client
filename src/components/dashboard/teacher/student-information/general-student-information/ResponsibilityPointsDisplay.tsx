...
export const RESPONSIBILITY_POINTS_QUERY = gql`
	query findResponsibilityPointsByStudentId($input: FindResponsibilityPointsByStudentIdInput!) {
...
export const ResponsibilityPointsDisplay = ({
	...
	return (
		<div>
			...
			<div>{available ? currentMarkingPeriodResponsiblityPoints : 'No points assigned '}</div>
		</div>
	)
}
