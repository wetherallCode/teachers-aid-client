...
export const StudentDashboardHome = ({ me }: StudentDashboardHomeProps) => {
  ...
  // const message: string = `The last day for all 3rd Marking Period work will be Friday, April 17th at 8AM. No exceptions.`
  // const message: string = `I'm not going to be in today. I'm leaving you questions to complete *due at the end of class*. Please leave the reading packet on the desk! There will be a quiz tomorrow on Latin American Republics - A Notice to Europe. If you finish early, work on makeup work or redo your essays.`
  // const message: string = `I'm cancelling homework tonight because I'm sure many of you need a break from the marathon of missing work you completed in the wee hours of the night. You're welcome.`
