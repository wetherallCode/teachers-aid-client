import React, { useMemo, useState, useCallback, FC, useEffect, SyntheticEvent } from 'react'
...
export const StudentEssayEditor: FC<StudentEssayEditorProps> = ({ essay, submittedFinalDraft }) => {
	...
	const [updateWorkingDraft] = useMutation<UpdateWorkingDraft, UpdateWorkingDraftVariables>(
		UPDATE_WORKING_DRAFT_MUTATION,
		{
			...
			onCompleted: (data) => console.log(data.updateWorkingDraft.essay.workingDraft),
