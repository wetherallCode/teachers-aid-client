    ...
    simplePredicateGrader({
      completePredicate:
        ...
        question.completePredicate
          ...
          : question.completePredicate,
      correctSimplePredicate: question.simplePredicate,
      ...
      <RestatementDirectionsContainer>
        ...
        {question.helpingVerb === 'did' ? (
          <div>
            ...
            complete predicate. Most of the time it is one word, but often times
            can be two words. Verbs like take off, get away, let go are verb
            phrases so you would need to select both words. This can be tricky
