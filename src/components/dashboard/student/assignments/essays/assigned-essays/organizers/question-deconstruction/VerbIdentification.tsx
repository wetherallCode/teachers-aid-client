...
export const VerbIdentification = ({
	...
	console.log(question.helpingVerb !== 'did' && auxilaryVerbCheck && question.object !== null)
		...
		if (correctSimplePredicate && text) {
			...
			setTimeout(() => {
				...
				if (writingLevel === WritingLevelEnum.ACADEMIC) {
					...
					if (question.helpingVerb !== 'did' && auxilaryVerbCheck && question.object !== null) {
			...
			<RestatementDirectionsContainer>
				...
				{question.helpingVerb === 'did' ? (
					...
					<div>
						...
						{question.helpingVerb} is the verb which makes it a linking verb. If there is an action
						word after "{question.helpingVerb}", highlight both "{question.helpingVerb}" and the
						action word. If there isn't an action word after "{question.helpingVerb}," just double
						click "{question.helpingVerb}."
