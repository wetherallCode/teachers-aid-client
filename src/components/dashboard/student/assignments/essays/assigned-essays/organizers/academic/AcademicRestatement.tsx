...
export const AcademicRestatement: FC<AcademicRestatementProps> = ({ updateAcademicOrganizer }) => {
	...
	return (
		<>
			<AcademicPartsOfQuestionContainer>
				<PartsOfQuestionTitle>Set the Parts of the Question</PartsOfQuestionTitle>
				<AcademicPartContainer>
					<div>What is the Subject of the question: </div>
					<PartInput
						value={state.context.academicOrganizer.academicSentenceStructure.subject}
						onChange={(e: any) =>
							event({
				...
				<AcademicPartContainer>
					...
					<PartInput
						value={state.context.academicOrganizer.academicSentenceStructure.object!}
						onChange={(e: any) =>
							event({
