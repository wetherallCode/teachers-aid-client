...
import { Header, HomeLink, UserNameHeader } from './components/home/headerStyles'
import { LoginContainer, LoginToggle } from './components/home/homeStyles'
import { capitalizer, date } from './utils'
import styled from 'styled-components'
import { me_me, findCurrentSchoolDay, findCurrentSchoolDayVariables } from './schemaTypes'
...
function App() {
	...
	const { data, loading } = useQuery<findCurrentSchoolDay, findCurrentSchoolDayVariables>(
	...
	return (
		<AppContainer>
			...
			{me !== null && (
				<Nav isNavOpen={isNavOpen} setIsNavOpen={setIsNavOpen} toggleLogin={toggleLogin} me={me} />
			)}
			<Routes>
